...
Route::get('about', function () {
    $riTheme = \App\Models\SiteContent::getGroup('ri_theme');
    $patron = \App\Models\SiteContent::getGroup('patron');
    return view('about', compact('riTheme', 'patron'));
})->name('about');
...
Route::middleware([
    ...
    Route::put('site-settings/logo', [SiteSettingsController::class, 'updateLogo'])->name('site-settings.logo.update');
    Route::put('site-settings/ri-theme', [SiteSettingsController::class, 'updateRiTheme'])->name('site-settings.ri-theme.update');
    Route::put('site-settings/patron', [SiteSettingsController::class, 'updatePatron'])->name('site-settings.patron.update');
