...
<section class="bl-listing">
    <div class="bl-listing__inner">
        ...
        @else
        <div class="text-gray-400 dark:text-gray-500" style="text-align:center; padding:4rem 0;">
            ...
            <p class="text-gray-500 dark:text-gray-400" style="font-size:1.1rem;font-weight:600;">No posts yet</p>
