...
<head>
  ...
  <body>
    ...
    <div class="container mt-10 mb-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8">
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <select name="category" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    <option value="club_service" @if($post->category == 'club_service') selected @endif>Club Service</option>
                    <option value="community_service" @if($post->category == 'community_service') selected @endif>Community Service</option>
                    <option value="international_service" @if($post->category == 'international_service') selected @endif>International Service</option>
                    <option value="professional_development" @if($post->category == 'professional_development') selected @endif>Professional Development</option>
                    <option value="sports_and_recreation" @if($post->category == 'sports_and_recreation') selected @endif>Sports and Recreational Activities</option>
                    <option value="public_relations" @if($post->category == 'public_relations') selected @endif>Public Relations</option>
                    <option value="environment_wildlife_animal_welfare" @if($post->category == 'environment_wildlife_animal_welfare') selected @endif>Environment, Wildlife and Animal Welfare</option>
                    <option value="finance" @if($post->category == 'finance') selected @endif>Finance</option>
                    <option value="membership_development" @if($post->category == 'membership_development') selected @endif>Membership Development and Retention</option>
                    <option value="rotary_interact_coordinator" @if($post->category == 'rotary_interact_coordinator') selected @endif>Rotary and Interact Coordinator</option>
                    <option value="regional_engagement" @if($post->category == 'regional_engagement') selected @endif>Regional Engagement</option>
                    <option value="digital_services" @if($post->category == 'digital_services') selected @endif>Digital Services</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" name="slug" id="slug" value="{{ old('slug', $post->slug) }}" autocomplete="slug" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}" autocomplete="title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <textarea name="description" id="description" rows="4" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ old('description', $post->description) }}</textarea>
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" name="keywords" id="keywords" value="{{ old('keywords', $post->keywords) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $post->meta_title) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $post->meta_keywords) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
              </div>
