    ...
    <div class="w-full mx-auto py-10 bg-white">
        ...
        <div class="w-[90%] mx-auto flex md:gap-4 xs:gap-2 justify-center items-center pt-4">
            <div class="flex gap-2 items-center">
                <img src="{{ $project->avenues->first()->logo ?? 'default-logo-url.jpg' }}" alt="Avenue Logo" class="md:w-[2.2rem] md:h-[2.2rem] xs:w-[2rem] xs:h-[2rem] rounded-full" />
            ...
            <div class="grid lg:grid-cols-3 gap-3">
                ...
                <a class="group relative block rounded-xl" href="{{ route('projects.show', $recentProject->id) }}">
                    <div class="flex-shrink-0 relative rounded-xl overflow-hidden w-full h-[350px] before:absolute before:inset-x-0 before:z-[1] before:size-full before:bg-gradient-to-t before:from-gray-900/70">
                        <img class="size-full absolute top-0 start-0 object-cover" src="{{ Storage::url($recentProject->coverimage) }}" alt="Image Description">
                    </div>
                        ...
                        <div class="p-4 flex flex-col h-full sm:p-6">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="size-[46px] border-2 border-white rounded-full" src="{{ $recentProject->avenues->first()->logo ?? 'default-logo-url.jpg' }}" alt="Avenue Logo">
                                </div>
